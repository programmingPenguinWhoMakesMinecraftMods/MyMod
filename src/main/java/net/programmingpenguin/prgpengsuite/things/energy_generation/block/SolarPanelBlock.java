...
import net.programmingpenguin.prgpengsuite.things.energy_generation.entity.SolarPanelEntity;

public class SolarPanelBlock extends AbstractEnergyBlock {

    public SolarPanelBlock(AbstractBlock.Settings settings) {
        super(settings);
    }
