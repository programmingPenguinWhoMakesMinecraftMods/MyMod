...
public class FusionReactorBlock extends AbstractEnergyBlock {

    public FusionReactorBlock(AbstractBlock.Settings settings) {
        super(settings);
    }
    ...
    protected void openScreen(World world, BlockPos pos, PlayerEntity player) {
        ...
        if (blockEntity instanceof FusionReactorEntity) {
