...
public abstract class AbstractEnergyEntity extends LockableContainerBlockEntity implements SidedInventory, RecipeUnlocker, RecipeInputProvider, Tickable {
    ...
    protected RecipeType<? extends AbstractCookingRecipeCompat> recipeType;

    public AbstractEnergyEntity(BlockEntityType<?> blockEntityType, RecipeType<? extends AbstractCookingRecipeCompat> recipeType) {
        ...
        this.propertyDelegate = new PropertyDelegate() {
            public int get(int index) {
                switch(index) {
                    case 0:
                        return AbstractEnergyEntity.this.burnTime;
                    case 1:
                        return AbstractEnergyEntity.this.fuelTime;
                    case 2:
                        return AbstractEnergyEntity.this.cookTime;
                    case 3:
                        return AbstractEnergyEntity.this.cookTimeTotal;
                    default:
                        return 0;
                }
            }
            ...
            public void set(int index, int value) {
                switch(index) {
                    case 0:
                        AbstractEnergyEntity.this.burnTime = value;
                        break;
                    case 1:
                        AbstractEnergyEntity.this.fuelTime = value;
                        break;
                    case 2:
                        AbstractEnergyEntity.this.cookTime = value;
                        break;
                    case 3:
                        AbstractEnergyEntity.this.cookTimeTotal = value;
                }
    ...
    public static Map<Item, Integer> createFuelTimeMap() {
        ...
        addFuel(map, ItemRegistry.CLEANING_FLUID, 2000);
        return map;
    }
    ...
    protected int getCookTime() {
        int cookTime = this.world.getRecipeManager().getFirstMatch(this.recipeType, this, this.world).map(AbstractCookingRecipeCompat::getCookTime).orElse(200);
        return (int) (cookTime / 1);
    }
